...
class Holerite():
    ...
    def calcular_inss(self) -> float:
        ...
        return round(inss, 2), aliquota_inss
    ...
    def inserir_holerite_db(self) -> None:
        ...
        inserir_holerite = (f"""
                        INSERT INTO holerite (mes/ano, matricula, faltas, inss, irrf, fgts, salario_liquido) 
    ...
    def gerar_holerite(self) -> None:
        ...
        consultar_holerite = (
            f"SELECT * FROM holerite WHERE matricula = {self.matricula} AND mes/ano = {self.mes_ano};")
